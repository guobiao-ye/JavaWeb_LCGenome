                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="main-banner-content">
                            <h5>WE SERVE LUNG CANCER HEALTH CARE SERVICE</h5>
                            <h1>ZJU-UOE LCGenome</h1>
                            ...
                            <div class="banner-btn">
                                <a href="#0" class="default-btn-one"> Learn More<span></span></a>
                                <div class="video-box">
                                    <a href="#" class="popup-video">
                                        <div class="video-icon"><i class="fa fa-play"></i></div>
                                        <span class="video-sub-title">Watch Video</span>
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-services-item">
                    ...
                    <div class="services-btn">
                        <a href="login.jsp" class="read-more"><i class="bi bi-arrow-right-short"></i> Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-services-item">
                    ...
                    <h3>PPI Analysis</h3>
                    <p>This module provides personalized PPI analysis support to visualize the associations between individual lung cancer-related genes</p>
                    <div class="services-btn">
                        <a href="login.jsp" class="read-more"><i class="bi bi-arrow-right-short"></i> Read More</a>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6 counter-item">
                <div class="single-counter">
                    <div class="counter-contents">
                        ...
                        <h3 class="counter-heading">Gene target</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 counter-item">
            ...
            <div class="col-lg-3 col-md-6 counter-item">
                <div class="single-counter">
                    <div class="counter-contents">
                        ...
                        <h3 class="counter-heading">Team member</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 counter-item">
                ...
                <div class="single-pricing-content">
                    ...
                    <div class="price-features">
                        <ul>
                            ...
                            <li>Autonomous inquiry</li>
                            <li>Discount medicine</li>
                            <li class="offer-list-none"><del>Gift of health products</del></li>
                            <li class="offer-list-none"><del>Drug development program</del></li>
                            <li class="offer-list-none"><del>1-on-1 treatment plan</del></li>
                        </ul>
                    </div>
                    <div class="price-btn">
                ...
                <div class="single-pricing-content">
                    ...
                    <div class="price-features">
                        <ul>
                            ...
                            <li>Discount medicine</li>
                            <li>Gift of health products</li>
                            <li>Drug development program</li>
                            <li>1-on-1 treatment plan</li>
                        </ul>
                    </div>
                    <div class="price-btn">
                        <a href="#" class="price-btn-one">Get Started</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-team-box">
                    <div class="team-image">
                        <img src="static/picture/team-1.jpg" alt="team">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-team-box">
                    <div class="team-image">
                        <img src="static/picture/team-2.jpg" alt="team">
                        <div class="team-social-icon">
                            <a href="#" class="social-color-1"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" class="social-color-2"><i class="fab fa-twitter"></i></a>
                            <a href="#" class="social-color-3"><i class="fab fa-linkedin"></i></a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-team-box">
                    <div class="team-image">
                        <img src="static/picture/team-3.jpg" alt="team">
                        <div class="team-social-icon">
                            <a href="#" class="social-color-1"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" class="social-color-2"><i class="fab fa-twitter"></i></a>
                            <a href="#" class="social-color-3"><i class="fab fa-linkedin"></i></a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-team-box">
                    <div class="team-image">
                        <img src="static/picture/team-4.jpg" alt="team">
                        <div class="team-social-icon">
                            <a href="#" class="social-color-1"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" class="social-color-2"><i class="fab fa-twitter"></i></a>
                            <a href="#" class="social-color-3"><i class="fab fa-linkedin"></i></a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-team-box">
                    <div class="team-image">
                        <img src="static/picture/team-5.jpg" alt="team">
                        <div class="team-social-icon">
                            <a href="#" class="social-color-1"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" class="social-color-2"><i class="fab fa-twitter"></i></a>
                            <a href="#" class="social-color-3"><i class="fab fa-linkedin"></i></a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-team-box">
                    <div class="team-image">
                        <img src="static/picture/team-6.jpg" alt="team">
                        <div class="team-social-icon">
                            <a href="#" class="social-color-1"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" class="social-color-2"><i class="fab fa-twitter"></i></a>
                            <a href="#" class="social-color-3"><i class="fab fa-linkedin"></i></a>
...
<section class="faq-section home-faq bg-grey section-padding">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="faq-img">
                    <img src="static/picture/faq.png" alt="images">
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <div class="section-title">
                ...
                <div class="faq-accordion first-faq-box">
                    <ul class="accordion">
                        <li class="accordion-item">
                            <a class="accordion-title active" href="javascript:void(0)"> <i class="fa fa-plus"></i> What is the purpose of this website?</a>
                            <p class="accordion-content show">This website is used to help users know more information about lung cancer. This website introduced the symptoms of lung cancer. The website also introduced the pathogenic genes and the targeted medicine. Besides, this website offered the treatment information.</p>
                        </li>
                        <li class="accordion-item">
                            <a class="accordion-title" href="javascript:void(0)"> <i class="fa fa-plus"></i> How can I search for information I’ m interested in?</a>
                            <p class="accordion-content">You can click the "Services" and turn to services page. The services part contains the data and information of this website. You can search for information you’re interested in.</p>
                        </li>
                        <li class="accordion-item">
                            <a class="accordion-title" href="javascript:void(0)"> <i class="fa fa-plus"></i> How can I get help or give some suggestions about this website?</a>
                            <p class="accordion-content">You can go to the "contact" page. At that page, you can ask for help and give suggestions.</p>
                        </li>
                        <li class="accordion-item">
                            <a class="accordion-title" href="javascript:void(0)"> <i class="fa fa-plus"></i> How can I get the treatment plan?</a>
                            <p class="accordion-content">You can go to the "pricing" page. At that page, we offered the different pricing treatment plans.</p>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-8 offset-lg-2 col-md-12">
                <div class="hire-content">
                    ...
                    <div class="hire-btn">
                        ...
                        <a class="default-btn-one" href="contact.jsp">Contact Us<span></span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div id="partner-carousel" class="partner-carousel owl-carousel owl-theme owl-loaded">
            <div class="partner-slide-item">
                <a href="#0">
                    <img src="static/picture/client-1.png" alt="partner-image">
                </a>
            </div>
            <div class="partner-slide-item">
                <a href="#0">
                    <img src="static/picture/client-2.png" alt="partner-image">
                </a>
            </div>
            <div class="partner-slide-item">
                <a href="#0">
                    <img src="static/picture/client-3.png" alt="partner-image">
                </a>
            </div>
        </div>
    </div>
