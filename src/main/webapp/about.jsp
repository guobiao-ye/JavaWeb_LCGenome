...
<body>
			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-12">
					<div class="about-content">
						<h6 class="sub-title">About Our Web: Lung Cancer Genomic Database</h6>
						<h2>Diagnosis & Treatment</h2>
						<p>The ZJU-UoE Institution presents a genomic database for lung cancer research, facilitating precise diagnostics and targeted therapies</p>
						<div class="skills">
							<div class="skill-item">
								<h6>Diagnosis and prevention <em>80%</em></h6>
								<div class="skill-progress">
									<div class="progres" data-value="80%"></div>
								</div>
							</div>
							<div class="skill-item">
								<h6>Targeted therapy <em>95%</em></h6>
								<div class="skill-progress">
						...
						<div class="about-btn-box"> 
							<a class="default-btn" href="">Learn More<span></span></a>
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-md-12">
					<div class="about-image">
						<img src="static/picture/about.jpg" alt="About Images">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="partner-list">
				<div class="partner-item">
					<a href="#0">
						<img src="static/picture/client-1.png" alt="image">
					</a>
				</div>
				<div class="partner-item">
					<a href="#0">
						<img src="static/picture/client-2.png" alt="image">
					</a>
				</div>
				<div class="partner-item">
					<a href="#0">
						<img src="static/picture/client-3.png" alt="image">
					</a>
				</div>
				<div class="partner-item">
					<a href="#0">
						<img src="static/picture/client-4.png" alt="image">
					</a>
				</div>
				<div class="partner-item">
					<a href="#0">
						<img src="static/picture/client-5.png" alt="image">
					</a>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-2 col-md-6 col-sm-6">
						<div class="single-footer-widget">
							...
							<ul class="footer-quick-links">
								...
								<li> <a href="#">Mutation Frequency</a></li>
								<li> <a href="#">Symptom Inquiry</a></li>
								<li> <a href="#">Gene-Symptom</a></li>
	...
	<div class="copyright-area">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6">
					<p> <i class="far fa-copyright"></i> Copyright &copy; 2024.Guobiao Ye All rights reserved.<a target="_blank" href="https://sc.chinaz.com/moban/"></a></p>
				</div>
				<div class="col-lg-6 col-md-6">
					<ul>
						<li> <a href="terms-condition.jsp">Terms & Conditions</a></li>
