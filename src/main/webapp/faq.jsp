				...
				<div class="col-lg-10 offset-lg-1">
					<div class="faq-accordion first-faq-box">
						<ul class="accordion">
							...
							<li class="accordion-item">
								<a class="accordion-title" href="javascript:void(0)"> <i class="fa fa-plus"></i> Where is the source of this related information of this website?</a>
								<p class="accordion-content">All the information of this website is from reliable and scientific sources. And the doctors and the team members are from famous labs. You can trust us completely.</p>
							</li>
						</ul>
					</div>
				</div>
