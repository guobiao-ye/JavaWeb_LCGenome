	                ...
	                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
	                    <ul class="navbar-nav">
	                        ...
	                        <li class="nav-item">
	                            ...
	                            <ul class="dropdown-menu">
	                                <li class="nav-item">
	                                    <a href="portfolio.jsp" class="nav-link">Portfolio</a>
	                                </li>
	                                <li class="nav-item">
	                                    <a href="single-portfolio.jsp" class="nav-link">Portfolio Details</a>
	                                </li>
	                            </ul>
	                        </li>
	                        <li class="nav-item">
	                        ...
	                        <li class="nav-item">
	                            ...
	                            <ul class="dropdown-menu">
	                                ...
	                                <li class="nav-item">
	                                    <a href="blog-2.jsp" class="nav-link"> Blog Right Sidebar </a>
	                                </li>
	                                <li class="nav-item">
	                                    <a href="single-blog.jsp" class="nav-link"> Blog Details </a>
	                                </li>
	                            </ul>
	                        </li>
	                        <li class="nav-item">
